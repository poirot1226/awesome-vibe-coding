...
* [NextReset](https://nextreset.ai/) — Free Codex reset companion with source-linked reset history, official AI-service incident updates, and a browser-local personal allowance timer.
